    ...
    <>
      {option === "Dropdown" ? (
        <select
          ...
          className="focus:shadow-none w-3/4 px-2 py-1 form-select outline-none h-10 text-sm focus:outline-none block rounded-md bg-gray-100 border-transparent focus:bg-white border-primary-600 focus:border-primary-400 focus:ring-0 focus:ring-primary-200"
          name="parent"
        >
          {[
            ...new Map(
                  ...
                  (el) =>
                    ...
                    el?._id === vl[att] && (
                      <button
                        ...
                        className={`${
                          Object?.values(selectVariant).includes(vl[att])
                            ? "bg-primary-500 text-white mr-2 border-0 rounded-full inline-flex items-center justify-center px-3 py-1 text-xs font-serif mt-2 focus:outline-none"
