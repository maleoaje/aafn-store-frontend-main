export const storeCustomization = {
  ...
  home: {
    ...
    quick_delivery_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our All American Foods Network shop and get some special offers. See Our latest discounted products from here and get a special discount.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem All American Foods Network-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
    },
    ...
    daily_need_title: {
      en: "Get Your Daily Needs From Our All American Foods Network Store",
      de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem All American Foods Network-Shop",
    },
    daily_need_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our All American Foods Network shop and get some special offers.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem All American Foods Network-Shop und erhalten Sie einige Sonderangebote.",
    },
  ...
  about_us: {
    ...
    top_title: {
      en: "Welcome to our All American Foods Network shop",
      de: "Willkommen in unserem All American Foods Network-Shop",
    },
    top_description: {
  ...
  contact_us: {
    ...
    email_box_email: {
      en: "info@allamericanfoodsnetwork.com",
      de: "info@allamericanfoodsnetwork.com",
    },
    email_box_text: {
  ...
  faq: {
    ...
    faq_one: {
      en: "How does the All American Foods Network work?",
      de: "Wie funktioniert das All American Foods Network?",
    },
    description_one: {
    ...
    faq_five: {
      en: "What is All American Foods Network EC2 auto scaling?",
      de: "Was ist die automatische Skalierung von All American Foods Network EC2?",
    },
    description_five: {
      en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
    ...
    faq_six: {
      en: "What are the benefits of using All American Foods Network affliate?",
  ...
  footer: {
    ...
    block2_sub_link1: "/search",
    block2_sub_title2: {
      en: "Soft Drink",
      de: "Erfrischungsgetränk",
    },
    block2_sub_link2: "/search",
    block2_sub_title3: {
      en: "Milk & Dairy",
      de: "Milch und Milchprodukte",
    },
   
    block2_sub_link4: "/search",
    block3_title: {
      en: "My Account",
      de: "Mein Konto",
    },
  ...
  seo: {
    ...
    meta_description: "All American Foods Network - Grocery & Organic Food Store",
    meta_img:
      "https://res.cloudinary.com/ahossain/image/upload/v1636729752/facebook-page_j7alju.png",
    meta_keywords: "e-commerce, online store, grocery, organic food",
    meta_title:
      "All American Foods Network - Grocery & Organic Food Store",
    meta_url: "https://allamericanfoodsnetwork.com/",
  },
};
