                  ...
                  >
                    {storeCustomizationSetting?.navbar
                      ...
                      <Popover className="relative font-serif">
                        <Popover.Button className="group inline-flex items-center py-2 hover:text-primary-600 focus:outline-none">
                          ...
                          <ChevronDownIcon
                            className="ml-1 h-3 w-3 group-hover:text-primary-600"
                            aria-hidden="true"
                          />
                        </Popover.Button>
                    ...
                    {storeCustomizationSetting?.navbar?.about_menu_status && (
                      <Link
                        ...
                        className="font-serif mx-4 py-2 text-sm font-medium hover:text-primary-600"
                      >
                        {showingTranslateValue(
                    ...
                    <Popover className="relative font-serif">
                      <Popover.Button className="group inline-flex items-center py-2 text-sm font-medium hover:text-primary-600 focus:outline-none">
                        <span>
                          {showingTranslateValue(
                    ...
                    {storeCustomizationSetting?.navbar?.offers_menu_status && (
                      <Link
                        href="/offer"
                        onClick={() => setIsLoading(!isLoading)}
                        className="relative inline-flex items-center  bg-red-100 font-serif ml-4 py-0 px-2 rounded text-sm font-medium text-red-500 hover:text-primary-600"
                      >
                        {showingTranslateValue(
